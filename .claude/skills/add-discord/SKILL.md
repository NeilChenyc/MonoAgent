---
name: add-discord
description: Add Discord bot channel integration to MonoAgent.
---

# Add Discord Channel

This skill adds Discord support to MonoAgent, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/monoagent-discord.git
```
...
4. Service is running: `launchctl list | grep monoagent`
...
- @mention translation (Discord `<@botId>` → MonoAgent trigger format)
