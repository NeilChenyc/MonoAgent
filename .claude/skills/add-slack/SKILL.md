...
This skill adds Slack support to MonoAgent, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/monoagent-slack.git
```
...
>
> The JID format for MonoAgent is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.monoagent`
