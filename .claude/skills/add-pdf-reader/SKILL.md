---
name: add-pdf-reader
description: Add PDF reading to MonoAgent agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/monoagent.log | grep -i pdf
```
