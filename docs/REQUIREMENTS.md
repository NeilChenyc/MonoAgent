...
MonoAgent gives you the core functionality without that mess.
...
- Custom `monoagent` MCP server (inside container) provides scheduling tools
...
**MonoAgent** - A reference to Clawdbot (now OpenClaw).
