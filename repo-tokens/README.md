...
```yaml
- uses: qwibitai/monoagent/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [MonoAgent](https://github.com/qwibitai/MonoAgent) | ![tokens](https://raw.githubusercontent.com/qwibitai/MonoAgent/main/repo-tokens/badge.svg) |
